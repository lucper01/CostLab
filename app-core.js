const APP_KEY='costlab-calculator-v2-empty';
const SNAP_KEY='costlab-calculator-snapshot-v2-empty';
...
function defaultStudy(name=''){
 return {id:uid(),name,code:'',status:'',startDate:'',endDate:'',targetN:0,validN:0,exclusionRate:0,dropoutRate:0,techLossRate:0,pilotN:0,sessionsPerParticipant:0,compensation:0,sessionMinutes:0,overheadRate:0,tags:[],description:'',createdAt:new Date().toISOString(),
 consumables:[],personnel:[],equipment:[],services:[],travel:[],funding:[],expenses:[],orders:[],scenarios:[]};
}
function emptyState(){
 return {settings:{theme:'light',accent:'green',lang:'fr',scale:'1',contrast:false,dyslexia:false,motion:false,currency:'EUR',sidebarCollapsed:false},studies:[],activeStudyId:null};
}
let state=(()=>{try{return JSON.parse(localStorage.getItem(APP_KEY))||emptyState()}catch{return emptyState()}})();
